...
INSERT INTO items (discriminator,state,itemHandlerBeanName,name,parentitemname,parentitemtype,template_id,contextItemName,subtype,type,userid,extendeditem_id,createdtimestamp,lastmodifiedtimestamp, uuid, publicationStatus)
VALUES ('PortalFoundation','INSTANTIATED','portalFoundationHandler','[BBHOST]',null,null,null,'[BBHOST]',null,'PORTALFOUNDATION',null,null,now(), now(), '413c44e2-59b8-47b3-997a-427f224b14a7', 'NOT_PUBLISHED');
...
insert into acl_class (id, class) values (5, 'com.backbase.portal.foundation.domain.model.Include');
insert into acl_class (id, class) values (6, 'com.backbase.portal.foundation.domain.conceptual.PropertyDefinition');
insert into acl_class (id, class) values (7, 'com.backbase.portal.foundation.domain.model.Template');
insert into acl_class (id, class) values (8, 'com.backbase.portal.foundation.domain.model.PortalFoundation');
insert into acl_class (id, class) values (9, 'com.backbase.portal.foundation.domain.conceptual.ContentItemRef');
insert into acl_class (id, class) values (10, 'com.backbase.portal.foundation.domain.model.Link');

INSERT INTO acl_object_identity (object_id_class, object_id_identity, owner_sid, entries_inheriting) VALUES (8, @item_id, @group_admin_sid, false);
